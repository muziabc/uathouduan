...
$ npm i
$ npm run dev
$ open http://localhost:7001/deepexi-eggjs
```

swagger地址：http://localhost:7001/swagger-ui.html  
swagger json：http://127.0.0.1:7001/swagger-doc  
...
- APP_NAME: 指定镜像和容器的名称，默认为`deepexi-eggjs`
